...
annotate ZCDSEHBTC0003.ZTHBT0020 with @(UI : {
    HeaderInfo         : {
        TypeName       : '',
    ...
    Facets             : [{
        ...
        Facets : [{
            ...
            Target : '@UI.FieldGroup#MainTC',
            Label  : 'Task Code'
        }]
    }],
    FieldGroup #MainTC : {Data : [
        {Value : ZTCODE},
        {Value : ZTCDS},
        {Value : ZOBJECT},
        {Value : KOKRS}
...
annotate ZCDSEHBTC0003.ZTHBT0019 with @(UI : {
    HeaderInfo         : {
        TypeName       : '',
...
annotate ZCDSEHBTC0002.ZTHBT0022 with @(UI : {
    SelectionFields : [
        InvoiceID,
        CompanyCode,
        ProjectID
